					...
					<div class="callout border-0">
						...
						<form action="" id="add_sched">
							...
							<div class="form-group">
								<label for="assembly_hall_id" class="control-label">Location</label>
							...
							<div class="form-group">
								<label for="schedule_remarks" class="control-label">Event Name:</label>
...
<script>
	...
	$(function(){
		...
		$('.select2').select2({placeholder:"Please Select Location/Room"})
